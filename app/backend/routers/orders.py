...
def get_reorder_candidates(dias: int = 30, limit: int = 15):
    """Customers whose last order was more than `dias` days ago — prime reorder targets."""
    from datetime import timedelta

    # Fetch all non-cancelled orders, most recent first
    all_orders = db.raw_select("orders", {
